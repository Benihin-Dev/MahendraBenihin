...
export default function Templet({ details }) {
  return (
    <div className="w-full">
      <div className="relative p-5 border-white border bg-[#faf6f5]">
        <div className=" group parentClass overflow-hidden   ">
          <img
            src={details.img}
            className="w-full group-hover:scale-150 duration-1000"
            alt=""
          />
