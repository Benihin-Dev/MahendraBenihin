...
const HorizontalScrollSection = ({ mainComponentHeight }) => {
  ...
  const Part1 = () => {
    return (
      <div className="  sm:flex  bg-[#f4f1f1] gap-5 w-full px-5 sm:px-10 p-5  sm:pt-16 h-screen  ">
          ...
          >
            ...
            {sectionWeith >= 50 ? (
              <div
                style={{
                  transform:
                    sectionWeith > 50
                      ? `rotate(${Math.max(sectionWeith / 50, -5)}deg)`
                      : " ",
                }}
            ...
            {sectionWeith >= 100 ? (
              <div
                style={{
                  transform:
                    sectionWeith > 100
                      ? `rotate(${Math.min(sectionWeith / -100, 10)}deg)`
                      : " ",
                }}
                className=" absolute shadow-xl shadow-gray-300 top-1 left-4 w-full h-full border bg-white   p-4 flex items-center justify-center border-gray-400"
              >
                <div className="  ">
                  <div className=" w-full  pb-5 sm:pb-3 md:pb-5 flex items-center justify-center">
                    <img
            ...
            {sectionWeith >= 150 ? (
              <div
                ...
                className=" absolute  shadow-xl shadow-gray-300 top-2 -left-2 w-full h-full border bg-white   p-4 flex items-center justify-center border-gray-400"
              >
                <div className="  ">
                  <div className=" w-full  pb-5 sm:pb-3 md:pb-5 flex items-center justify-center">
                    <img
  ...
  const Part2 = () => {
    return (
      <div className={`  sm:flex p-5 w-full sm:pt-16 h-screen `}>
        <div
          className={` ${
            sectionWeith >= 49 ? "invisible" : " "
          }  w-full sm:w-1/2  md:p-10 flex items-center justify-center h-1/2 sm:h-full `}
        >
          <div className=" aspect-square w-full sm:w-[95%] lg:w-[80%]  md:w-[85%] p-5 relative">
  ...
  const Part3 = () => {
    return (
      <div className={`sm:flex gap-5 w-full  sm:pt-16 h-screen    `}>
        <div
          className={` ${
            sectionWeith >= 148 ? "invisible" : " "
          }  w-full sm:w-1/2 md:p-10 flex items-center justify-center h-1/2 sm:h-full `}
        >
          <div className=" aspect-square w-full sm:w-[95%] lg:w-[80%]  md:w-[85%] p-3 relative">
            <div className="   w-full h-full border bg-white   shadow-xl shadow-gray-300 border-gray-400 p-4 flex items-center justify-center">
              <div className="  ">
                <div className=" w-full  pb-5 sm:pb-3 md:pb-5 flex items-center justify-center">
                  <img
        ...
        <div
          className={` ${
            sectionWeith >= 148 ? "invisible" : " "
          }  w-full sm:w-1/2 md:p-10 border flex items-center justify-center h-1/2 sm:h-full `}
        >
          <div className=" aspect-square w-full sm:w-[95%] lg:w-[80%]  md:w-[85%] p-3 relative">
            <div className="  w-full h-full border bg-white   p-4 flex items-center justify-center  ">
              <div className="  ">
                <div className=" w-full  pb-5 sm:pb-3 md:pb-5 flex items-center justify-center">
                  <img
                    src="https://uiparadox.co.uk/templates/voguify/assets/media/vector/vector-3.png"
  ...
  return (
    <>
      ...
      <div className=" w-full h-screen overflow-y-hidden left-0  z-20 fixed top-0  hrSection   ">
        <div
          style={{ width: `${mainComponentHeight + 300}vw` }}
